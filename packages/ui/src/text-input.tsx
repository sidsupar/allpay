...
export const TextInput = ({ label, setTextValue, placeholder }: inputField) => {
  return (
    <div>
      <div className="relative">
        <input className="block rounded-t-lg px-2.5 pb-2.5 pt-5 w-full text-sm 
          ...
          onInput={(e) =>{
            ...
            setTextValue(tgt?.value);
          }}
          />

          <label className="absolute text-sm text-gray-500 dark:text-gray-400 
